...
public class DependencyEvaluator2 {
	...
	public static List<Double> evaluate(String act_file, String pred_file,
		...
		if (hasConfidence) {
			predictedReader = DependencyReader
		...
		while (goldInstance != null) {
			...
			if (islog){
				if (!whole){
//					System.out.println("Characters: " + Arrays.toString(goldInstance.forms));
//					System.out.println("gold Head: " + Arrays.toString(goldInstance.heads));
//					System.out.println("gold Deprel: " + Arrays.toString(goldInstance.deprels));
//					System.out.println("pred Head: " + Arrays.toString(predInstance.heads));
//					System.out.println("pred Deprel: " + Arrays.toString(predInstance.deprels));
//					System.out.println();
				}
